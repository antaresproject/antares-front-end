...
const AntaresBrandColors = {
  ...
  resetStyle() {
    $('.reset-style').click(function() {
      ...
      $(
        '.cp-brand.cp-brand--typo.cp-brand--primary .cp-brand__preview:first-of-type input'
      ).val('#050505');
      $(
        '.cp-brand.cp-brand--typo.cp-brand--primary .cp-brand__preview:last-of-type input'
      ).val('#084700');

      $(
        '.cp-brand.cp-brand--typo.cp-brand--secondary .cp-brand__preview:first-of-type input'
      ).val('#fafafa');
      $(
        '.cp-brand.cp-brand--typo.cp-brand--secondary .cp-brand__preview:last-of-type input'
      ).val('#7a0000');

      $(
        '.cp-brand.cp-brand--typo.cp-brand--tetriary .cp-brand__preview:first-of-type input'
      ).val('#940000');
      $(
        '.cp-brand.cp-brand--typo.cp-brand--tetriary .cp-brand__preview:last-of-type input'
      ).val('#f88888');
