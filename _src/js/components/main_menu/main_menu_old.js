...
(function(window) {
    ...
    $(function() {
        ...
        require('./../menu_mobile/menu_mobile.js');
        ...
        enquire.register("screen and (max-width:767px)", {
            ...
            match: function() {
                ...
                menu.find('>li.has-submenu >a').on('click', function(e) {
                ...
                // Close menu on click everywhere else
                $(document).on('click.menusmall', '.app-content', function(){
                    if ( siteWrapper.hasClass('mobile-menu-active') ) {
                        siteWrapper.toggleClass('mobile-menu-active');
                    }
                });
