            ...
            if (c.page.len() !== h) {
                var b = f.aLengthMenu,
                    ...
                    b = a.map(g, function (b, a) {
                        return b == c.page.len() ? '<a class="active mdl-js-button mdl-js-ripple-effect" data-length="' +
                            g[a] + '">' + d[a] + '</a>' : '<a class="mdl-js-button mdl-js-ripple-effect" data-length="' + g[a] + '">' + d[a] + '</a>';
                    });
