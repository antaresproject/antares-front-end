...
const AntaresForms = {
    ...
    init() {
        ...
        (function UiElements() {
            ...
            self.elements.mobileSelectMenu();
            self.elements.scrollCloseDropdowns();
            // self.elements.hoverCloseDropdowns();
            self.elements.activateWithSelected();
            self.elements.ddownUpZIndex();
            self.elements.mobileDdownFilter();
            // self.elements.emailPageAddDataScroll();
    ...
    elements: {
        ...
        search() {
            ...
            //Screen Size <768
            enquire.register('screen and (max-width:767px)', {// #62 768 -> 767
                match: function () {
        ...
        tooltip() {
            ...
            enquire.register('screen and (max-width: 1365px)', {
                match: function () {
                    $('[data-tooltip-mobile="true"]').each(function () { // Notice the .each() loop, discussed below
                        $(this).qtip({
                            style: {
                                classes: 'ar',
                                tip: {
        ...
        closeAllDropdowns() {       //In console   AntaresForms.elements.closeAllDropdowns()
        ...
        scrollCloseDropdowns() {
            ...
            $('.app-content').bind('mousewheel DOMMouseScroll MozMousePixelScroll', function (event) {
        ...
        activateWithSelected() {
            $('.card-ctrls').click();
            $('#table-ma').click(function () {
                if ($('#table-ma').attr('disabled')) {
                    $('.ui-selectee').removeClass('ddown--open');
                }
                else {
                    $('.ui-selectee').addClass('ddown--open');
                }
            });
        },
        ddownUpZIndex() {
        ...
        mobileDdownFilter() {
            ...
            $('.add-filter').click(function () {
                $(this).closest('.ddown__content').find('.ddown-multi__submenu').removeClass('is-active');
            });
        },
        emailPageAddDataScroll() {
            setTimeout(function () {
                $('#preview').contents().find('body').attr('data-scrollable', true);
            }, 8000);
        }
    }
};
