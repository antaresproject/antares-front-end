...
export default {
    ...
    gsHeightAdjust($elem) {
        ...
        $('.card--chart').on('click', '.card__mobile-toggle', () => {
            window.requestAnimationFrame(() => {
                console.log('cliclicklcik')
                $('.card--chart').adjustCardHeight();
            });
        });
        enquire.register('screen and (min-width:768px) and (max-width:1366px) ', {
            match() {
                // card chart
                $('.card--chart [data-icheck="true"]').on('ifChanged.forAdjustCardHeight', function () {
                    $(this)
                        .closest('.card')
                ...
                $('.card--info').on('click.forAdjustCardHeight', '.mobile-toogle--box', () => {
                    window.requestAnimationFrame(() => {
                ...
                $('.card--contacts').on('click.forAdjustCardHeight', '.card__mobile-toggle', () => {
                    window.requestAnimationFrame(() => {
            ...
            unmatch(){
                $('.card--chart [data-icheck="true"]').off('ifChanged.forAdjustCardHeight')
                $('.card--info').off('click.forAdjustCardHeight')
                $('.card--contacts').off('click.forAdjustCardHeight')
            }
        });
    ...
    gsDashboardRWD() {
        ...
        if (dashboard.length) {
            ...
            enquire.register('screen and (min-width: 1367px)', {
                match() {
                    window.requestAnimationFrame(() => {
                        ...
                        c3.cardResize(0, 16, 12, 10);
                        c4.cardResize(12, 16, 12, 10);
                        systemInfo.cardResize(0, 26, 6, 10);
                        news.cardResize(6, 26, 6, 10);
                        systemLogs.cardResize(12, 36, 12, 12);
                    });
                }
            });
            enquire.register('screen and (min-width:1024px) and (max-width: 1366px)', {
            ...
            enquire.register('screen and (min-width:768px)  and (max-width:1023px)', {
                match() {
                    c1.cardResize(0, 0, 12, 15);
                    c2.cardResize(12, 0, 12, 15);
                    c3.cardResize(0, 15, 12, 15);
                    c4.cardResize(12, 15, 12, 15);
                    systemInfo.cardResize(0, 30, 12, 13);
                    news.cardResize(12, 30, 12, 13);
                    systemLogs.cardResize(0, 43, 24, 17);
                }
            });
        }
    },
