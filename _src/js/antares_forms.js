...
const AntaresForms = {
    ...
    elements: {
        ...
        updateHeightChartJS() {
            ...
            enquire.register(bpDesBigMax1449, {
                match: function () {
                    updateHeight('mob');
                    $(window).resize(
                        _.debounce(function () {
        ...
        logsCorrectTimelineBorder() {
            let thisTimeline = $('.timeline')
            thisTimeline.each(function () {
                $(this).children('li').removeClass('is-logs--show');
                $(this).children('li:visible:last').addClass('is-logs--show');
            })
        },
