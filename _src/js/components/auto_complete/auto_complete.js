            ...
            _renderMenu: function(ul, items) {
                ...
                $.each(items, function(index, item) {
                    ...
                    if (item.category != currentCategory) {
                        ...
                        for (key in self.sampleData.categoryUrls) {

                            if (key.toLowerCase() === item.category.toLowerCase()) {
                                ul.append("<li class='ui-autocomplete-category'><a href='" + self.sampleData.categoryUrls[key] + "'>" + item.category + "</a></li>");
                                currentCategory = item.category;
                            }

                        }

                        if (!self.sampleData.categoryUrls.hasOwnProperty(item.category.toLowerCase())) {
