    ...
    var notificationTemplates = {
        ...
        variablesPanel: function () {
            $('.mdl-tabs .mdl-tabs--open-variables-panel').on('click', function () {
                $(this)
                    .closest('.mdl-tabs')
                    .addClass('mdl-tabs--open-variables-panel');
            });
            $('.mdl-tabs--close-variables-panel, .variables-pane__mobile-button a').on('click', function () {
                $(this)
                    .closest('.page-notification-templates')
                    .find('.mdl-tabs--open-variables-panel')
                    .removeClass('mdl-tabs--open-variables-panel');
            });
        ...
        initCodeMirror: function () {
            ...
            this.mirrorHTMLEditor = CodeMirror.fromTextArea(htmlEditor, $.extend({}, CM_cfg, {
                mode: 'xml',
                htmlMode: true
            }));
        ...
        insertVariable: function () {
            ...
            $('.variables-pane .variables-pane__paste').on('click', function () {
                var $dataPre = $(this)
                    .closest('.variables-pane__instruction-content')
                    .find('pre');
