...
AntaresCharts.prototype.init = function() {
    ...
    // ready('.card--chart .chart svg', function(element) {

        $(document).ready(function() {
            
            AntaresCharts.setSizes();
            AntaresCharts.sortData();
            AntaresCharts.compare();
            // AntaresCharts.painter();
            AntaresCharts.RWD();
        });
    ...
    // AntaresCharts.resize();
    // AntaresCharts.reDrawControl();
    // $('.chart').removeClass('animated lightSpeedIn');
    // $('.chart').css('opacity', '0.05');
...
AntaresCharts.prototype.painter = function() {
    ...
    setTimeout(function() {
        ...
        if ( $('#chart--one').length ) {
            AntaresCharts.lineChart('chart--one', random1, 'linear', 'oh, very clean!');
        }

        if ( $('#chart--two').length ) {
            AntaresCharts.lineChart('chart--two', random2, 'basis', 'clean');
        }

        if ( $('#chart--three').length ) {
            AntaresCharts.lineChart('chart--three', random3, 'basis', 'clean');
        }

        if ( $('#chart--four').length ) {
            //bar chart
            AntaresCharts.barChart('chart--four');
        }
...
AntaresCharts.prototype.compare = function() {
...
AntaresCharts.prototype.sortData = function() {

    var data = AntaresCharts.data;
...
AntaresCharts.prototype.RWD = function() {
...
// AntaresCharts.prototype.reDrawControl = function() {

//     function job() {

//         setTimeout(function() {
//             console.log(AntaresCharts.painter());
//             AntaresCharts.painter();
//         }, 100);
//     }
...
AntaresCharts.prototype.setSizes = function() {
...
AntaresCharts.prototype.lineChart = function(elementId, data, lineEasing, clean) {
    ...
    //         var tooltipArray = [];
    //         for (i = 0; i < data.length; i++) {
    //             tooltipArray.push(moment(data[i].date).format('YYYY-MM-DD'));
    //         }

    //         return "<div class='d3-tip__inner'><strong>Sample Value:</strong> <span style='color:#02A8F3'>" + tooltipArray[Math.floor(Math.random() * tooltipArray.length)] + "</span></div>";
    //     });
...
AntaresCharts.prototype.barChart = function(elementId) {
    ...
    var data = AntaresCharts.data.barChart1;
