	...
	function buildButtonPanel(classnameContext, options, handlers) {
		...
		function init() {
			...
			if (options.applyButtonText) {
				applyButton = $('<button type="button" class="btn btn--primary btn--md mdl-button mdl-js-button mdl-js-ripple-effect mr8"></button>')
			...
			if (options.clearButtonText) {
				clearButton = $('<button type="button" class="btn btn--dark btn--md mdl-button mdl-js-button mdl-js-ripple-effect mr8"></button>')
			...
			if (options.cancelButtonText) {
				cancelButton = $('<button type="button" class="btn btn--red btn--md mdl-button mdl-js-button mdl-js-ripple-effect"></button>')
